...
-- Stores predefined expense categories for better organization.
...
-- 6. EXPENSES TABLE
-- Stores individual expenses for trips.
...
-- 7. EXPENSE_PARTICIPANTS TABLE
-- Tracks which participants are involved in each expense.
