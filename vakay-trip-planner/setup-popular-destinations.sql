...
CREATE TABLE IF NOT EXISTS popular_destinations (
  ...
  name text NOT NULL,
  name_normalized text NOT NULL, -- Normalized name for search (without diacritics)
...
CREATE INDEX IF NOT EXISTS idx_popular_destinations_name_normalized ON popular_destinations(name_normalized);
...
INSERT INTO popular_destinations (
  place_id, name, name_normalized, display_name, category, type, country, region, city, 
  lat, lon, importance, place_rank, boundingbox
) VALUES 
  (238016130, 'Angkor Wat', 'Angkor Wat', 'Angkor Wat, Siem Reap, Cambodia', 'tourism', 'attraction', 'Cambodia', 'Siem Reap', 'Siem Reap', 13.4124426, 103.8665873, 0.557888037798644, 30, ARRAY['13.4083770', '13.4165641', '103.8614147', '103.8717328']),
  (123456789, 'Taj Mahal', 'Taj Mahal', 'Taj Mahal, Agra, Uttar Pradesh, India', 'tourism', 'attraction', 'India', 'Uttar Pradesh', 'Agra', 27.1751448, 78.0399535, 0.789123456789012, 25, ARRAY['27.1740000', '27.1760000', '78.0380000', '78.0410000']),
  (987654321, 'Paris', 'Paris', 'Paris, Île-de-France, France', 'place', 'city', 'France', 'Île-de-France', 'Paris', 48.856614, 2.352222, 0.987654321098765, 10, ARRAY['48.8000000', '48.9000000', '2.3000000', '2.4000000']),
  (456789123, 'Bali', 'Bali', 'Bali, Indonesia', 'place', 'island', 'Indonesia', 'Bali', 'Denpasar', -8.3405389, 115.0919509, 0.876543210987654, 15, ARRAY['-8.8000000', '-8.0000000', '114.5000000', '115.5000000']),
  (789123456, 'Yellowstone National Park', 'Yellowstone National Park', 'Yellowstone National Park, Wyoming, United States', 'tourism', 'attraction', 'United States', 'Wyoming', 'Jackson', 44.4280, -110.5885, 0.765432109876543, 20, ARRAY['44.0000000', '45.0000000', '-111.0000000', '-110.0000000'])
